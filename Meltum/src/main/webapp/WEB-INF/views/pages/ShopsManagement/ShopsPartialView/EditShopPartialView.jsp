        ...
        <div class="modal-content">
            ...
            <form:form role="form" action="/Meltum/ShopsManagement/EditShop/${shop.id}" method='POST' modelAttribute="shopForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <form:input path="adresse.state" type="hidden" name="administrative_area_level_1" id="administrative_area_level_1" value="${shop.adresse.state}" class="form-control" placeholder="Région" readonly="true" />
                    </div>
                    <div class="form-group">
