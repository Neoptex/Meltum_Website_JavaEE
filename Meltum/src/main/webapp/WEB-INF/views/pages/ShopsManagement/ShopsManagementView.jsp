	...
	<div class="container">
		<div class="row">
			<div class="page-header">
				<h1>Gestion des shops
					<button type="button" class="btn btn-success btn-xs" style="background:#9C27B0;border-color:#7B1FA2;" data-toggle="modal" data-target="#StatisticsAllShop">
						<i class="fa fa-pie-chart fa-fw"></i> Statistiques de tous les shops
					</button>
				</h1>
			</div>
		</div>
		<%@ include file="ShopsPartialView/StatisticsAllShop.jsp"%>
		<div class="row">
			<!-- Menu filtre shop -->
			<div class="col-md-3">
				<div class="row">
			...
			<div class="col-md-9">
				<c:forEach items="${shops}" var="shop">
					...
					<%@ include file="ShopsPartialView/Statistics.jsp"%>
							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="text-right">
										<button type="button" class="btn btn-success btn-xs" style="background:#9C27B0;border-color:#7B1FA2;" data-toggle="modal" data-target="#Statistics${shop.id}">
											<i class="fa fa-pie-chart fa-fw"></i> Statistiques
										</button>
