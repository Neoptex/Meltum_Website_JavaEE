			...
			<form:form id="AddForm" role="form" action="/Meltum/MeltsManagement/AddMelt" method='POST' modelAttribute="meltForm">
				<div class="modal-body">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-6">
								<i class="fa fa-asterisk fa-fw text-danger"></i><label for="priceInit">Prix avant réduction</label>
								<form:input path="priceInit" pattern="[0-9]+(\.[0-9]{0,2})?%?" maxlength="10" type="text" name="priceInit" id="priceInit" class="form-control" placeholder="50.45€" required="required" />
							</div>
							<div class="col-md-6">
								<i class="fa fa-asterisk fa-fw text-danger"></i><label for="price">Prix après réduction</label>
								<form:input path="price" pattern="[0-9]+(\.[0-9]{0,2})?%?" maxlength="10" type="text" name="price" id="price" class="form-control" placeholder="25.99€" required="required" />
							</div>
						</div>
					</div>
					<div class="form-group">
