		...
		<div class="modal-content">
			<div class="modal-header modal-header-warning">
				...
				<h4 class="modal-title text-center">
					<i class="fa fa-pencil fa-fw"></i> Modifier <strong>${melt.name}</strong>
				</h4>
			</div>
			<form:form id="EditForm${melt.id}" role="form" action="/Meltum/MeltsManagement/EditMelt/${melt.id}" method='POST' modelAttribute="meltForm">
				<div class="modal-body">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-6">
								<i class="fa fa-asterisk fa-fw text-danger"></i><label for="name">Prix avant réduction</label>
							...
							<div class="col-md-6">
								<i class="fa fa-asterisk fa-fw text-danger"></i><label for="name">Prix après réduction</label>
...
<script>
	...
	$('#EditForm' + "<c:out value='${melt.id}'/>").parsley();
</script>